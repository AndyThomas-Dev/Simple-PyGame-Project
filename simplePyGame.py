...
while running:
    ...
    # Added this to slow the game down
    # 60 is the same as 60 frames per second
    ...
    for event in pygame.event.get():
        ...
        # Whenever event handler sees the new ADDENEMY event
    ...
    if pygame.sprite.spritecollideany(player, enemies):
        ...
        player.kill()
        print("You have died! Ending game...")
